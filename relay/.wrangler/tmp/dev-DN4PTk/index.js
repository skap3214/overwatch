...
var Room = class {
  ...
  async fetch(request) {
    ...
    const role = url.pathname.includes("/host") ? "host" : "client";
    if (this.peers.some((p) => p.role === role)) {
...
// .wrangler/tmp/bundle-pIRPpW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pIRPpW/middleware-loader.entry.ts
