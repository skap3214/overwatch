...
- As of 2026-04-05, Cartesia WebSocket TTS is returning real PCM chunks from the Overwatch backend, and Deepgram prerecorded STT is successfully transcribing uploaded WAV audio. For the current push-to-talk UX, Deepgram prerecorded upload is sufficient; live STT streaming can wait.
